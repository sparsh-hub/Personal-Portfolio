      ...
      <div className="center-point relative w-[150px] sm:w-[200px] md:w-[250px] lg:w-[300px] aspect-square">
        {gallery.map((card, index) => {
          return (
            <div
              key={index}
              className="image-wrapper absolute w-[180px] sm:w-[220px] md:w-[280px] lg:w-[150px] xl:w-[300px] aspect-square rounded-lg p-2 sm:p-3 md:p-4 bg-[#fafafa] shadow-lg sm:shadow-xl md:shadow-2xl invisible"
